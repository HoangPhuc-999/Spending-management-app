...
File Structure
.
├── main.py         # Main application file, contains GUI logic
├── mydb.py         # Custom class for handling the SQLite database
├── finance.db      # Database file (will be created automatically)
└── assets/
